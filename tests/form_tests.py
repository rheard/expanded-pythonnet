...
from .utils import ExpandedTestCase, Form, Button
...
class PointConversionTests(ExpandedTestCase):
    ...
    def test_conversion(self):
        ...
        form = Form()
        self.assertIsInstance(form.location, expanded_clr.datatypes.Point)
    ...
    def test_python_type(self):
        ...
        form = Form(location=expanded_clr.datatypes.Point(12, 12))
        self.assertEqual(form.location, (12, 12))
        self.assertIsInstance(form.location, expanded_clr.datatypes.Point)
...
class SizeConversionTests(ExpandedTestCase):
    ...
    def test_conversion(self):
        ...
        form = Form()
        self.assertIsInstance(form.size, expanded_clr.datatypes.Size)
        self.assertIsInstance(form.auto_scale_dimensions, expanded_clr.datatypes.Size)  # Test SizeF
    ...
    def test_python_type(self):
        """Test that setting the Python namedtuple type works"""
        form = Form(size=expanded_clr.datatypes.Size(200, 200))
        self.assertEqual(form.size, (200, 200))
        self.assertIsInstance(form.size, expanded_clr.datatypes.Size)
...
class RectangleConversionTests(ExpandedTestCase):
    ...
    def test_conversion(self):
        ...
        form = Form()
        self.assertIsInstance(form.desktop_bounds, expanded_clr.datatypes.Rectangle)
...
class PaddingConversionTests(ExpandedTestCase):
    ...
    def test_conversion(self):
        """Test that Size is converted correctly from C# to begin with"""
        form = Form()
        self.assertIsInstance(form.margin, expanded_clr.datatypes.Padding)
    ...
    def test_python_type(self):
        """Test that setting the Python namedtuple type works"""
        form = Form(margin=expanded_clr.datatypes.Padding(10, 11, 12, 13))
        self.assertEqual(form.margin, (10, 11, 12, 13))
        self.assertIsInstance(form.margin, expanded_clr.datatypes.Padding)
